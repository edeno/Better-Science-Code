...
3. Documenting your functions using the numpy/scipy format: https://github.com/numpy/numpy/blob/master/doc/example.py, https://github.com/numpy/numpy/blob/master/doc/HOWTO_DOCUMENT.rst.txt .
 This description should include:
    * A one-line summary that does not use variable names or the function name
    * A few sentences giving an extended description (optional, only if time)
